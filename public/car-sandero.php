...
<link rel="stylesheet" href="assets/css/car-sandero.css?v=<?= time() ?>">
...
<div class="sandero-content-wrapper">
    ...
    <div class="sandero-card">
        ...
        <img class="sandero-image" src="assets/images/info/sandero-info2.jfif"
            alt="Dacia Sandero - detalii suplimentare">
    </div>
